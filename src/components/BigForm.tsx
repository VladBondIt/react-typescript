...
// Массив ПОЗИШНС типизирован дженерик типом обекта позишн в котором в свою очередь сторого типизированы поля,
// в нашем случае все ключи содержат значения строки.
...
// Отдельная типизация для стилей
const styles: React.CSSProperties = { display: 'block', marginBottom: '10px' };

class BigForm extends Component<{}, FormState> {
    ...
    // Создание ссылки в классовом компаненте и её типизация
